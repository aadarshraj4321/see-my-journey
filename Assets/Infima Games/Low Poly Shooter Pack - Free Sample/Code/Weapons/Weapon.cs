...
// MODIFIED FOR PORTFOLIO PROJECT
...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        [SerializeField]
        private float projectileImpulse = 800.0f;
...
public override void Fire(float spreadMultiplier = 1.0f)
{
    ...
    if (Physics.Raycast(new Ray(playerCamera.position, playerCamera.forward), out RaycastHit hit, maximumDistance, mask))
    {
        ...
        // --- START OF COMPLETE INTERACTION LOGIC ---
        ...
        else 
        {
            ...
            {
                // Check for the NEW insect health script
                InsectHealth_v2 insect = hit.transform.GetComponent<InsectHealth_v2>();
                if (insect != null)
                {
                    insect.TakeDamage(1);
                }
        ...
        // --- END OF COMPLETE INTERACTION LOGIC ---
    }
